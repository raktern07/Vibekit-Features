...
export class Agent {
  ...
  async init() {
    this.conversationHistory = [
      {
        role: 'system',
        content: `You are an AI agent that provides access to blockchain swapping functionalities via Maxxit AI On-chain Actions. You use the tool "swapTokens" to swap or convert tokens. You can also answer questions about Camelot DEX using the "askEncyclopedia" tool.
